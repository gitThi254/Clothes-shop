...
import { ImageHttpReq } from "../../../../../products/$id/upload";
...
function UploadProductImage({ data }: { data: ProductItem }) {
  const { id, itemId } = Route.useParams();
  ...
  const { mutate, isPending } = useUploadImageItem();
      ...
      { id, data: formData },
      {
        onSuccess: () => {
          queryClient.invalidateQueries({
            queryKey: ["products", id.toString(), "item"],
          });
